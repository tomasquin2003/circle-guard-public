...
## Fase Kubernetes - validaci�n local en Docker Desktop
- **Fecha:** May 14, 2026
...
- **Limitaciones reales:** La inicializaci�n de Spring Boot masiva excede los delays estrictos definidos en los probes.
- **Comandos principales ejecutados:** kubectl apply -f k8s/dev/*, kubectl get pods -n circleguard-dev, kubectl port-forward ... 


### Correcci�n de Startup Probes
- **Problema:** identity-service y promotion-service reiniciaban constantemente en k8s local debido a un livenessProbe agresivo.
- **Soluci�n:** Se agreg� un startupProbe expl�cito en ambos d�ndoles amplia holgura de inicializaci�n.
